                ...
                <div v-if="loaded" class="d-flex flex-wrap justify-content-between">
                    ...
                    <div class="d-inline-flex mb-4">
                        ...
                        <div class="d-flex flex-column me-2">
                            <img @click="pictureReplacement(product.image_url)" :src="product.image_url" alt="" width="50" class="mb-2" style="cursor: pointer;">
                            <img @click="pictureReplacement(productImage.url)" v-for="productImage in product.product_images" :src="productImage.url" alt="" width="50" class="mb-2" style="cursor: pointer;">
                        </div>
                        <div class="bg-image hover-zoom hovereffect">
                            <img :src="product.image_url" class="figure-img" width="500" height="500" alt="..." id="bigProductImage">
                        </div>
                        <div class="d-flex flex-column p-3 pb-0 pt-0 flex-grow-0">
                            ...
                            <h5 class="card-text text-secondary fw-bold">{{ product.price.slice(0, -3) }}<h6
                                class="ms-2 d-inline"><i class="fas fa-ruble-sign"></i></h6></h5>
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="#" class="w-100 m-0 btn btn-warning">В корзину <i
